...
<head>
    ...
    <title>Şifre Sıfırlanamadı</title>
...
<body>
    <div class="container">
        <div class="content">
            <h2>BAŞARISIZ</h2>
            <h4>Şifre sıfırlama işlemin tamamlanamadı :(</h4>
            <p>5 saniye içerisinde otomatik olarak giriş yapma ekranına yönlendirileceksin.</p>
